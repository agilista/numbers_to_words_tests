...
public class ExclusionFilterTest {
    ...
    @Test
    public void wontAcceptDS_Store() {
    ...
    @Test
    public void wontAcceptIntellijFiles() {
        ExclusionFilter unit = new ExclusionFilter();
    ...
    @Test
    public void wontAcceptEclipseFiles() {
        ExclusionFilter unit = new ExclusionFilter();
    ...
    @Test
    public void willAcceptIntellijishFiles() {
        ExclusionFilter unit = new ExclusionFilter();
    ...
    @Test
    public void wontAcceptGitFiles() {
        ExclusionFilter unit = new ExclusionFilter();
